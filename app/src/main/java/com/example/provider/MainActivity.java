...
public class MainActivity extends ListActivity {
    ...
    protected void ListContacts(){
        ...
        Cursor c;
        CursorLoader cursorLoader = new CursorLoader(this,allContacts,projection,ContactsContract.Contacts.DISPLAY_NAME + " LIKE ?",
                new String[] {"%Lee"},ContactsContract.Contacts.DISPLAY_NAME + " ASC");
        c = cursorLoader.loadInBackground();
        this.PrintContacts(c);
